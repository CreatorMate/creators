    ...
    <section class="flex screen-size flex-col">
        ...
        <div class="flex flex-grow justify-center px-6">
            <div class="w-[850px] max-w-full mt-20 flex flex-col">
                ...
                <p class="text-[#8D8D8D] font-medium mt-2 w-[440px] max-w-full">When we or one of our brands want to
                    work with you they will show up here. You can then accept to work with them and allow them to view
                    the analytics of your account.</p>
                <div class="mt-2">
